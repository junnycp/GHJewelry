...
var AppSidebarNav = function (_Component) {
    ...
    AppSidebarNav.prototype.navTitle = function navTitle(title, key) {
        ...
        if (this.props.validMenu.indexOf(title.name) <= -1) {
            return "";
        }
    ...
    AppSidebarNav.prototype.navWrapper = function navWrapper(item) {
        return item.wrapper && item.wrapper.element ?
            React.createElement(item.wrapper.element, item.wrapper.attributes, this.props.t(item.name + Constants.SUFFIX_TITLE))
            : this.props.t(item.name + Constants.SUFFIX_TITLE);
    };
    ...
    AppSidebarNav.prototype.navDropdown = function navDropdown(item, key) {
        ...
        if (this.props.validMenu.indexOf(item.name) <= -1) {
            return "";
        }
        return React.createElement(
            'li',
            ...
            React.createElement(
                'a',
                {className: 'nav-link nav-dropdown-toggle fa', href: '#', onClick: this.handleClick},
    ...
    AppSidebarNav.prototype.render = function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                Nav,
                null,
                children || this.navList(navConfig, this.props.validMenu)
            )
        );
    };
...
export default withTranslation()(AppSidebarNav);
