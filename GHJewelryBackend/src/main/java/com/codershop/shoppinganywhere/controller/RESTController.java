...
public class RESTController<E, P extends Serializable> {
    ...
    public APIResponse findById(@PathVariable P id) {
        return new APISuccReponse().withMessage(AppConstants.MESSAGE.SUCCESS).withBody(genericService.findById(id));
    }
    ...
    public APIResponse findAll(@RequestBody List<OrderBy> orderBys) throws Exception {
        return new APISuccReponse().withMessage(AppConstants.MESSAGE.SUCCESS).withBody(genericService.queryAllAndSort(orderBys));
    }
    ...
    public APIResponse page(@RequestParam int page, @RequestParam int size, @RequestBody List<OrderBy> orderBys) {
        ...
        return new APISuccReponse().withMessage(AppConstants.MESSAGE.SUCCESS).withBody(responseBody);
    }
    ...
    public APIResponse create(@RequestBody @Valid E e) {
        ...
        return new APISuccReponse().withMessage(AppConstants.MESSAGE.CREAT_SUCCESS).withBody(createdObject);
    }
    ...
    public APIResponse update(@RequestBody @Valid E e) {
        ...
        return new APISuccReponse().withMessage(AppConstants.MESSAGE.UPDATE_SUCCESS).withBody(updatedObj);
    }
    ...
    public APIResponse delete(@PathVariable P id) {
        ...
        return new APISuccReponse().withMessage(AppConstants.MESSAGE.DELETE_SUCCESS).emptyBody();
    }
    ...
    public APIResponse query(@Valid @NonNull @RequestBody QueryRequest<E> queryRequest) {
        ...
        if (!(resultObj instanceof Page<?>)) {
            return new APISuccReponse().withMessage(AppConstants.MESSAGE.SUCCESS).withBody(resultObj);
        }
        Page<E> pPage = (Page<E>) (resultObj);
        PagnationRespBody<E> responseBody = new PagnationRespBody<E>().withContent(pPage.getContent())
                .withTotalPage(pPage.getTotalPages()).withNumRec(pPage.getNumberOfElements());
        return new APISuccReponse().withMessage(AppConstants.MESSAGE.SUCCESS)
